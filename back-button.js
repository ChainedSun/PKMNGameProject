...
class BackButton {
  ...
  changeStyle(boolVal) {
    if(boolVal) {
      this.svg.classList.add("alt")
      this.path1.classList.add("alt")
      this.path2.classList.add("alt")
    } 
    else {
      this.svg.classList.remove("alt")
      this.path1.classList.remove("alt")
      this.path2.classList.remove("alt")
    }
  }
